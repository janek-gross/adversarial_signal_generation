...
def discriminator(x):
    ...
    state_0 = tf.keras.layers.Activation(lambda x: tf.keras.activations.relu(x, alpha=0.1))(state_0)
    ...
    state_1 = tf.keras.layers.Activation(lambda x: tf.keras.activations.relu(x, alpha=0.1))(state_1)
